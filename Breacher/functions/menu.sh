...
while true && [[ ! "$IP" == " " ]];do
        ...
        if [[ ! -d "$IP/results" ]];then mkdir -p $IP/results;fi
        if [[ ! -d "$IP/results/loot/raw" ]];then mkdir -p $IP/results/loot/raw; loot="$IP/results/loot";else loot="$IP/results/loot";fi
...
#                        ;;
#                "list modules")
                        # while base breacher runs nmap an analysis based on services discovered, this module tatgets and deeply analyses target services while base breacher glosses over services found
#			echo "[*] Validate"
#			echo "[*] Fingerprinting"
#			echo "[*] Web"
#			echo "[*] Samba"
...
#				module="Validate";cli="breacher($IP)$WHITE [$module]$CLEAR > "
#				mkbasedirs
...
#				module="Fingerprinting";cli="breacher($IP)$WHITE [$module]$CLEAR > "
#                                mkbasedirs
#                                mkdir -p $loot/Modules/$module
...
#				module="Web";cli="breacher($IP)$WHITE [$module]$CLEAR > "
#                                mkbasedirs
#                                mkdir -p $loot/Modules/$module
...
#				module="DNS";cli="breacher($IP)$WHITE [$module]$CLEAR > "
#                                mkbasedirs
#                                mkdir -p $loot/Modules/$module
...
#                                DNS
#                        elif [[ "$module" == "AD" ]];then
#				module="AD";cli="breacher($IP)$WHITE [$module]$CLEAR > "
#                                mkbasedirs
#                                mkdir -p $loot/Modules/$module
...
#				module="Samba";cli="breacher($IP)$WHITE [$module]$CLEAR > "
#                                mkbasedirs
#                                mkdir -p $loot/Modules/$module
